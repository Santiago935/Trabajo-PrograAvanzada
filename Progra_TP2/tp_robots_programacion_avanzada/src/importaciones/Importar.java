    ...
    public void leerArchivoOferta(ArrayList<Item> listaItems, ArrayList<Cofre> listaCofres) {
        ...
        try {
            ...
            while ((linea = lector.readLine()) != null) {
                ...
                if (auxCofre != null && itemAux != null) {
                    switch (auxCofre) {
                        case CofreBufer cofreBufer -> cofreBufer.agregarOferta(itemAux, cantidadSolicitada);
                        case CofreProvisionActiva cofreProv -> cofreProv.agregarOferta(itemAux, cantidadSolicitada);
                        default -> System.out.println("Tipo de cofre no reconocido: " + auxCofre.getId());
                    }
                } else {
                    // Reporto que no existe.
                    System.out.println("Item o Cofre no encontrado: " + id_cofreSolicita + " o " + id_Item);
    ...
    public void leerArchivoSolicitud(ArrayList<Item> listaItems, ArrayList<Cofre> listaCofres) {
        ...
        try {
            ...
            while ((linea = lector.readLine()) != null) {
                ...
                if (auxCofre != null && itemAux != null) {
                    switch (auxCofre) {
                        case CofreBufer cofreBufer -> cofreBufer.solicitarItem(itemAux, cantidadSolicitada);
                        case CofreSolicitud cofreSolicitud -> cofreSolicitud.solicitarItem(itemAux, cantidadSolicitada);
                        default -> System.out.println("Tipo de cofre no reconocido: " + auxCofre.getId());
                    }
                } else {
                    // Reporto que no existe.
